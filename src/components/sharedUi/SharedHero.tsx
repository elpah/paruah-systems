  ...
  return (
    <section className="relative overflow-hidden bg-[#0A2828] min-h-[60svh] flex items-end pt-28 pb-14 sm:pt-32 sm:pb-16 md:pt-40 md:pb-24">
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12">
        <span className="inline-block mb-4 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.28em] sm:tracking-[0.4em] text-[#C5A059]">
          {cat}
        </span>

        <h1 className="max-w-4xl mb-8 md:mb-12 text-[clamp(2.5rem,8vw,6rem)] font-bold text-white leading-[0.95] tracking-tight">
          {header}
        ...
        {paragraph && (
          <p className="max-w-2xl text-base sm:text-lg md:text-xl text-slate-400 leading-relaxed">
            {paragraph}
          </p>
        )}
      </div>
