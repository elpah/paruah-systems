    ...
    <section className="bg-[#0A2828] w-full min-h-[100svh] flex items-center pt-32 pb-20 relative overflow-hidden">
      <div className="w-full mx-auto relative z-10">
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <span className="inline-block text-[11px] font-bold uppercase tracking-[0.35em] text-[#C5A059] mb-6">
            Who We Are
          </span>

          <h1 className="text-[clamp(2.8rem,7vw,6.5rem)] font-bold text-white leading-[0.92] tracking-tight mb-10 max-w-5xl">
            Modern Software
            <span className="block italic font-light text-white/30">built with</span>
            <span className="block">Purpose.</span>
          </h1>

          <p className="text-base md:text-xl text-white/50 max-w-2xl leading-relaxed font-medium">
