        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-7 space-y-10 pt-2">
              ...
              <p className="text-xl text-slate-500 leading-relaxed">
                Paruah Systems was born from that frustration, shaped by firsthand experience with
                the medical system in Ghana.
              </p>
              <p className="text-xl text-slate-500 leading-relaxed">
                We believe that every organization, regardless of industry, deserves a single
                reliable digital system where their operations could be managed clearly and
                efficiently, instead of scattered across notebooks, spreadsheets, and manual
                processes.
              </p>
              <p className="text-xl text-slate-500 leading-relaxed">
