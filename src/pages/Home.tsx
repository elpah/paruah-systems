            ...
            {RECENT_WORKS.map((work, i) => (
              ...
              >
                <div className="relative aspect-[4/5.5] overflow-hidden rounded-[30px] bg-slate-100 mb-8 shadow-md">
                  ...
                  <div className="absolute bottom-8 left-8 right-8 translate-y-4 lg:opacity-0 lg:group-hover:translate-y-0 lg:group-hover:opacity-100 transition-all duration-500">
                    <a
                      href={work.link}
                      target="_blank"
